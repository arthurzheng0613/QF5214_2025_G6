...
for var in tqdm(variable_list, desc="Merging Variables"):
    ...
    if merged_df is None:
        ...
        merged_df = pd.merge(merged_df, df, on=['Latitude', 'Longitude', 'Timestamp'], how='outer')
...
# === Save Merged Data ===
merged_df = merged_df.sort_values(by=['Latitude', 'Longitude', 'Timestamp']).reset_index(drop=True)
